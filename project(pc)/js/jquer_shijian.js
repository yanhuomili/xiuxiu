		        ...
		        sjObj.defaults={
		            ...
		            bindFun:function(){
		                ...
		                sjObj.opt.timeElm.find(".df-ok").on("click",function(){
		                    var str="";
		                    if(sjObj.opt.Year) {
		                        str = sjObj.opt.Format.replace("yyyy", sjObj.opt.yyyy);//获取年份
		                    }
		                    if(sjObj.opt.Month) {
		                        str = str.replace("mm", sjObj.opt.mm);//获取月份
		                    }
		                    if(sjObj.opt.Day) {
		                        str = str.replace("dd", sjObj.opt.dd)+" ";//获取天
		                    }
		                    str+=sjObj.opt.h+":"+sjObj.opt.m;//获取小时、分钟
		                    sjObj.opt.val=str;
		                    $('.appointment').attr('data',str);
